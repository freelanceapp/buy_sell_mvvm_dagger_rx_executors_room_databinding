...
import com.panaceasoft.psbuyandsell.repository.comment.CommentRepository;
...
public class CommentListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.panaceasoft.psbuyandsell.viewmodel.comment.CommentListViewModel.TmpDataHolder> sendCommentHeaderPostDataObj = new MutableLiveData<>();
    ...
    public void setSendCommentHeaderPostDataObj(String itemId,
        ...
        if (!isLoading) {
            com.panaceasoft.psbuyandsell.viewmodel.comment.CommentListViewModel.TmpDataHolder tmpDataHolder = new com.panaceasoft.psbuyandsell.viewmodel.comment.CommentListViewModel.TmpDataHolder();
