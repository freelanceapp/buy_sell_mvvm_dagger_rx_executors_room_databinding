package com.panaceasoft.psbuyandsell.viewmodel.comment;
...
import com.panaceasoft.psbuyandsell.repository.comment.CommentDetailRepository;
...
public class CommentDetailListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.panaceasoft.psbuyandsell.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder> sendCommentDetailPostDataObj = new MutableLiveData<>();
    //region Constructor
    ...
    public void setSendCommentDetailPostDataObj(String headerId,
        ...
        if (!isLoading) {
            com.panaceasoft.psbuyandsell.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder tmpDataHolder = new com.panaceasoft.psbuyandsell.viewmodel.comment.CommentDetailListViewModel.TmpDataHolder();
